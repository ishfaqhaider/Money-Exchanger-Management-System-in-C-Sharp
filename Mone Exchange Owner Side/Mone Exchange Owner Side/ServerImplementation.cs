...
{
    public class ServerImplementation : MarshalByRefObject
    {
        ...
        public bool Start_Server_Manually()
        {
        ...
        public DataSet GetCurrencySaleReport(String name, DateTime fm, DateTime to)
        {
            return dbh.GetCurrSaleReports(name,fm,to);
        }
        ...
        {
            return dbh.GetSalesManList();
        }
        public DataSet GetSalesmanReport(String salesman,DateTime f, DateTime t)
        {
            return dbh.GetSalesManReportDBH(salesman,f,t);
        }
